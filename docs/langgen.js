...
class dropecho_langgen_Consts {
	static getRandomCorthSet(random) {
		...
		let _g = [];
		let h = dropecho_langgen_Consts.corthsets.h;
		let k_h = h;
	...
	static getRandomVorthSet(random) {
		...
		let _g = [];
		let h = dropecho_langgen_Consts.vorthsets.h;
		let k_h = h;
		let k_keys = Object.keys(h);
		let k_length = k_keys.length;
		let k_current = 0;
	...
	static getRandomVowelSet(random) {
		let _g = [];
		let h = dropecho_langgen_Consts.vowel_sets.h;
		let x_h = h;
		let x_keys = Object.keys(h);
		let x_length = x_keys.length;
		let x_current = 0;
	...
	static getRandomSibilantSet(random) {
		let _g = [];
		let h = dropecho_langgen_Consts.sibilant_sets.h;
		let x_h = h;
		let x_keys = Object.keys(h);
		let x_length = x_keys.length;
		let x_current = 0;
	...
	static getRandomFinalSet(random) {
		let _g = [];
		let h = dropecho_langgen_Consts.final_sets.h;
		let x_h = h;
		let x_keys = Object.keys(h);
		let x_length = x_keys.length;
		let x_current = 0;
	...
	static getRandomLiquidSet(random) {
		let _g = [];
		let h = dropecho_langgen_Consts.liquid_sets.h;
		let x_h = h;
		let x_keys = Object.keys(h);
		let x_length = x_keys.length;
		let x_current = 0;
	...
	static getRandomRewriteSet(random) {
		let _g = [];
		let h = dropecho_langgen_Consts.rewritesets.h;
		let x_h = h;
		let x_keys = Object.keys(h);
		let x_length = x_keys.length;
		let x_current = 0;
...
class dropecho_langgen_Language {
	...
	createPhrase(key) {
		let keyExists = key != null && Object.prototype.hasOwnProperty.call(this.words.h,key);
		let subject = keyExists ? this.words.h[key] : this.createWord();
